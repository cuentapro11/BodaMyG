...
function initializeCountdown() {
    const targetDate = new Date('2026-01-04T17:00:00').getTime();
...
function showDressCode() {
    showToast("Dress Code", "Asistir con colores neutrales y no el color de la boda (Color de la boda: Azul Marino y Rosado) 👗");
}

function showTips() {
    showToast("Tips y Notas", "Por favor tener en cuenta que el evento está destinado únicamente para adultos. llegar 15 minutos antes ⛪");
}

function showGifts() {
    // MODIFICADO: Redirigir directamente a la página de números de cuenta
    window.open('https://cuentapro11.github.io/numero-modesto/', '_blank');
}
